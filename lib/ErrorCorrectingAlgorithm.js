...
const { Multiply, Invert, Log, Add, Divide } = require('./GaloisField');
...
class ErrorCorrectingAlgorithm {
  ...
  calculate() {
    ...
    this.t = GaloisFieldPolynomial.zero().euclideanAlgorithm(this.rNext, this.r).multiply(this.t).add(this.tNext);
...
module.exports = ErrorCorrectingAlgorithm;
